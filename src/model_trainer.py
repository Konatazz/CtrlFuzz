...
class model_trainer():
    ...
    def train(self, data_path, num_data, cls_min, reshapeType):
        ...
        print(f"**************************************************")
        dataset.get_first_n_classes_images(n_classes=20, n_images_per_class=10, output_dir='C:/Users/Administrator/Desktop/diffusion_change_unet/output_images/imagenet64')
